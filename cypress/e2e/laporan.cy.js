describe("Perjalanan Dinas > Menu Formulir", () => {
    beforeEach(() => {
        ...
        cy.visit("http://localhost:8000/perjadin/laporan");
    });

    it("apakah halaman tersedia dan dapat filter sesuai tahun, bulan, dan formulir", () => {
        ...
        // bisa menampilkan file yang diunggah
        cy.get("tbody tr")
            .first()
            .find(".btn-primary")
            .then(($btn) => {
