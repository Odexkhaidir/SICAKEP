            ...
            <form action="/team" method="post">
                ...
                <div class="form-group">
                    ...
                    <select id="year" class="form-control select2bs4" name="year" required>
                        ...
                        <option {{ old('year') == 2025 ? "selected" : "" }} value='2025'>2025</option>
                ...
                <div class="form-group">
                    ...
                    <select id="leader_id" class="form-control select2bs4" name="leader_id" required>
                        ...
                        @foreach ($users as $user)
                            <option {{ old('leader_id') == $user->id ? "selected" : "" }} value="{{ $user->id }}">{{ $user->name }}</option>
                        @endforeach
                    </select>
                    @error('leader_id')
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <select id="members" name="members[]" class="select2bs4" multiple="multiple" data-placeholder="Pilih Anggota Tim" style="width: 100%;">
                        @foreach ($users as $user)
