            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name-text"
                        name="name" placeholder="Nama Kegiatan" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <select id="jenisSelect"
                        ...
                        @foreach ($jenis_kegiatans as $jenis_kegiatan)
                            <option {{ old('jenis_kegiatan_id') == $jenis_kegiatan->id ? 'selected' : '' }}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('link') is-invalid @enderror" id="link-text"
                        name="link" placeholder="Link Laporan/Kelengkapan" value="{{ old('link') }}">
                    @error('link')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
