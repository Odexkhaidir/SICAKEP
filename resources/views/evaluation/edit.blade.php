                        ...
                        <div class="form-group">
                            ...
                            <select id="team" class="form-control select2bs4" name="team" required>
                                ...
                                @foreach ($teams as $team)
                                    <option {{ old('team', $evaluation->team_id) == $team->id ? 'selected' : '' }}
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="suboutput" class="form-control select2bs4" name="suboutput" required>
                                ...
                                @if ($evaluation->suboutput)
                                    @foreach ($evaluation->team->output as $output)
                                        @foreach ($output->suboutput as $suboutput)
                                            <option
                                                {{ old('suboutput', $evaluation->suboutput_id) == $suboutput->id ? 'selected' : '' }}
                                                value="{{ $suboutput->id }}">
                                    ...
                                    @endforeach
                                @else
                                    <option value="" selected>Tidak ada kegiatan</option>
                                @endif
                            </select>
                            @error('suboutput')
                                <div class="invalid-feedback">
                    ...
                    <tbody>
                        @foreach ($evaluation->score as $score)
                            <tr>
                                <td>
                                    {{ $score->satker->code }}
                                    <input type="hidden" class="form-control" id="{{ 'satker' . $score->satker->id }}"
                                        name="{{ 'satker_' . $score->satker->code }}"
                                        value="{{ $score->satker->code }}">
                                </td>
                                <td>
                                    {{ $score->satker->name }}
                                </td>
                                <td style="text-align:center">
                                    <input type="number" class="form-control"
                                        id="{{ 'realization_score_' . $score->satker->id }}"
                                        name="{{ 'realization_score_' . $score->satker->code }}"
                                        value="{{ $score->realization_score }}" max="100" step=".01">
                                </td>
                                <td style="text-align:center">
                                    <input type="number" class="form-control"
                                        id="{{ 'time_score_' . $score->satker->id }}"
                                        name="{{ 'time_score_' . $score->satker->code }}"
                                        value="{{ $score->time_score }}" max="100" step=".01">
                                </td>
                                <td style="text-align:center">
                                    <input type="number" class="form-control"
                                        id="{{ 'quality_score_' . $score->satker->id }}"
                                        name="{{ 'quality_score_' . $score->satker->code }}"
                                        value="{{ $score->quality_score }}" max="100" step=".01">
                                </td>
                                <td style="text-align:center">
                                    <input type="number" readonly class="form-control"
                                        id="{{ 'average_score_' . $score->satker->id }}"
                                        name="{{ 'average_score_' . $score->satker->code }}"
                                        value="{{ round($score->average_score, 2) }}">
                                </td>
                                <td style="text-align:center">
                                    <input type="text" class="form-control"
                                        id="{{ 'note_' . $score->satker->id }}"
                                        name="{{ 'note_' . $score->satker->code }}" value="{{ $score->note }}">
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
