                ...
                <tbody>
                    @foreach ($submissions as $submission)
                        <tr>
                            ...
                            <td class="text-center">{{ $submission->permindok->description }}</td>
                            <td class="text-center">{{ $submission->satker->name }}</td>
                            <td class="text-center"><a href="{{route('submission.detail', $submission->id)}}"><span class="badge bg-warning">lihat hasil</span></a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
