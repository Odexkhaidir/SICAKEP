<x-app-Layout>
    ...
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('submission.index') }}">Permindok</a></li>
                    ...
                    @foreach ($archieves as $archieve)
                        <tr>
                            ...
                            <td class="project-actions text-center">
                                ...
                                <a onclick="linkForm('{{ route('archieve.updatelink', $archieve->id) }}', '{{ $archieve->link }}')"
    ...
    <div class="modal fade" id="updatelink-modal">
            ...
            <form id="link-form" action="" method="post">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Link Dokumen</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control @error('link') is-invalid @enderror"
                                id="link-text" name="link" placeholder="Link Dokumen/Kelengkapan"
    ...
    <x-slot name="script">
        ...
        <script>
            ...
            function linkForm(url, link) {
                $('#link-form').attr('action', url);
                $('#link-text').attr('value', link);
                $('#updatelink-modal').modal();
            }
