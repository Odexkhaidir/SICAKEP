<x-app-Layout>
    ...
    <x-slot name="breadcrumb">
        <li class="breadcrumb-item active">Permindok</li>
    </x-slot>
                ...
                <tbody>
                    @foreach ($submissions as $submission)
                        <tr>
                            ...
                            <td class="text-center"><a href="{{route('submission.archieves', $submission->id)}}"><span class="badge bg-warning">daftar dokumen</span></a></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
