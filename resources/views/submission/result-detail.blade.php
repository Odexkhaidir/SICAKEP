<x-app-Layout>
    ...
    <x-slot name="title">
        {{ __('Hasil Pemeriksaan Permindok') }}
    </x-slot>
    ...
    <div class="card">
        ...
        <div class="card-header">
            <span class="badge badge-primary">Hasil Pemeriksaan</span>
            ...
            <table id="document-table" class="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Nama Dokumen/Kriteria</th>
                ...
                <tbody>
                    @foreach ($submission->archieve as $archieve)
                        <tr>
                            ...
                            <td colspan="4">
                                <a href="{{ $archieve->link }}" target="blank">
                                    <b>{{ $archieve->document->name }}</b>
                                </a>
                            </td>
                        </tr>
                        @foreach ($archieve->audit as $audit)
                            <tr>
                                <td></td>
