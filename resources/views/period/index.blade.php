                ...
                <tbody>
                    @foreach ($periods as $period)
                        <tr>
                            ...
                            <td class="text-center">{{ $period->month->name }}</td>
            ...
            <form id="periodForm" action="/period" method="post">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="month_id">Bulan:</label>

                            <select id="month" class="form-control col-sm-6 select2bs4" name="month_id">
