<x-app-Layout>
    ...
    <div class="card">
        ...
        <div class="card-header">
            <span class="badge badge-primary">Enrollment Permindok</span>
            <div class="card-tools">
                <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-lg">
                    <i class="fas fa-plus"></i> Add
                </button>
                <a href="{{ route('permindok.reenrollment', $permindok->id) }}" class="btn btn-sm btn-warning">
                    <i class="fas fa-refresh"></i> Enroll Ulang
                </a>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($permindok->submission as $submission)
                        <tr>
                            ...
                            <td class="text-center">{{ $submission->supervisor->name }}</td>
                            <td class="project-actions text-center">
                                <a class="btn btn-info btn-sm" href="/submission/{{ $submission->id }}/edit">
                                    <i class="fas fa-pencil-alt">
                                    </i>
                                    Edit
                                </a>
                                <a onclick="deleteConfirm('/submission/{{ $submission->id }}')"
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <form id="submission-form" action="/submission" method="post">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="satker_id">Satuan Kerja:</label>
                            <select id="satker" class="form-control select2bs4" style="width: 100%;"
                                name="satker_id">
                        ...
                        <div class="form-group">
                            <label class="col-form-label" for="supervisor_id">Supervisor:</label>
                            <select id="supervisor_id" class="form-control select2bs4" style="width: 100%;"
                                name="supervisor_id">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button id="submission-submit" type="submit" class="btn btn-success">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
