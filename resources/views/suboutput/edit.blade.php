<x-app-layout>
    ...
    <div class="card">
        ...
        <form action="/suboutput/{{ $suboutput->id }}" method="post">
            @csrf
            @method('put')
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <select id="outputSelect"
                                    ...
                                    <option value='{{ $suboutput->output->id }}' selected>{{ $suboutput->output->name }}</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <input name="name" type="text" class="form-control" id="name-input"
                                    placeholder="Output" value="{{ old('name', $suboutput->name) }}" required>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-left">
                                <select id="yearSelect"
                                    ...
                                    <option value="" disabled>Pilih Tahun</option>
                                        <option value='{{ $suboutput->year }}' selected>{{ $suboutput->year }}</option>
                                </select>
                            </td>
                        </tr>
                    </tbody>
